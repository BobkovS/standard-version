  ...
  return runLifecycleScript(args, 'prerelease')
    ...
    .then((release) => {
      if (!args.firstRelease) {
        ...
        updateConfigs(args, newVersion, releaseType)
      } else {
 ...
 * @return void
 */
function updateConfigs(args, newVersion, releaseType) {
  ...
  args.bumpFiles.forEach(function (bumpFile) {
    ...
    try {
      ...
      writeFile(
        args,
        configPath,
        updater.updater.writeVersion(contents, newVersion, releaseType)
      )
